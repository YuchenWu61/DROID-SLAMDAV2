...
from modules.extractor import BasicEncoderWAFT
...
class DroidNet(nn.Module):
    def __init__(self):
        ...
        self.encoder = self.freeze_(DepthAnythingFeature(model_name="vits", lvl=-3))
        self.fnet = BasicEncoderWAFT(output_dim=128, norm_fn='instance')
        self.cnet = BasicEncoderWAFT(output_dim=256, norm_fn='none')
